    ...
    sidebar: {
      '/guide/': [
        ...
        },
        {
          ...
          items: [
            {
              text: 'Lesson 1: SSR with URL-Prefix',
              link: '/guide/lesson-1-ssr-url-prefix',
            },
            {
              text: 'Lesson 2: Client with URL-Prefix',
              link: '/guide/lesson-2-client-url-prefix',
            },
            {
              text: 'Lesson 3: SSR with Context Mode',
              link: '/guide/lesson-3-ssr-context-mode',
            },
            {
              text: 'Lesson 4: Client with Context Mode',
              link: '/guide/lesson-4-client-context-mode',
            },
          ],
        },
      ],
