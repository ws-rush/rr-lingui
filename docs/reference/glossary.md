...
This glossary defines standard internationalization (i18n) and React Router concepts used throughout the `rr-lingui` documentation.

---

### BCP-47
A standardized format for language tags (e.g., `en`, `en-US`, `ar-EG`). `rr-lingui` supports BCP-47 language tags and automatically handles **regional fallback**: if a user requests `en-US` but your app only configures `en`, it automatically resolves to `en`.
